...
export class Dashboard {
    ...
    ngOnInit() {
        if (!isPresent(this.configuration)) {
    ...
    private initConfig() {
        AtexoRestConstant.request.panel.all.url = this.configuration.json.panel;
        AtexoRestConstant.request.alert.all.url = this.configuration.json.alert;
    }
